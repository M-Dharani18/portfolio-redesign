...
// function SkillsCarousel({ skillList }: { skillList: Skill[] }) {
...
//         .skill-carousel-item { flex-shrink: 0; }
//       `}</style>
//       <div className="skills-carousel" style={{ display: "flex", gap: "12px" }}>
//         {skillList.map((skill) => (
//           <div
//             key={skill.slug}
//             className="skill-carousel-item"
...
//                 e.currentTarget.style.boxShadow = `0 0 20px ${skill.color}38`;
//               }}
//               onMouseLeave={(e) => {
//                 e.currentTarget.style.borderColor = `${skill.color}38`;
...
//                 draggable={false}
//                 onError={(e) => {
//                   e.currentTarget.outerHTML = `<span style="font-size:12px;font-weight:700;color:${skill.color}">${skill.name.slice(0, 2).toUpperCase()}</span>`;
//                 }}
//               />
//             </div>
//             <span style={{ fontSize: "11px", color: "rgba(255,255,255,0.6)", whiteSpace: "nowrap", fontWeight: 500, textAlign: "center" }}>
//               {skill.name}
//             </span>
//           </div>
//         ))}
//       </div>
//       <div style={{
//         position: "sticky", right: 0, top: "50%", transform: "translateY(-50%)",
//         padding: "0 8px", fontSize: "11px", color: "rgba(255,255,255,0.3)",
//         pointerEvents: "none",
//       }}>
//         →
//       </div>
...
//   // Show carousel on mobile, sphere on desktop
//   if (isMobile) {
//     return (
//       <div style={{ position: "relative", width: "100%", minHeight: "180px", display: "flex", alignItems: "center" }}>
//         <SkillsCarousel skillList={skillList} />
//       </div>
//     );
//   }
...
//   useEffect(() => { 
//     positions.current = fibonacciSphere(skillList.length); 
//   }, [skillList.length]);
...
function IconSphere({ skillList }: { skillList: Skill[] }) {
  ...
  useEffect(() => {
    ...
    if (!el) return;
    const r = Math.min(el.offsetWidth, el.offsetHeight) * 0.38;
  ...
  // Desktop constants (safe here — after all hooks)
  const iconSize = 58;
  const imgSize = 28;
  const labelSize = 10;
  const gap = 5;
  const displayedSkills = skillList;
          ...
          >
            ...
            <div
              ...
              style={{
                borderRadius: "24px",
                border: "1px solid rgba(255,255,255,0.07)",
                background: "linear-gradient(145deg, rgba(110,231,183,0.03) 0%, rgba(56,189,248,0.02) 100%)",
                overflow: "hidden",
                position: "relative",
                minHeight: "380px",
                display: "flex",
            ...
            >
              ...
              <div
                style={{
                  ...
                  right: "15%",
                  height: "1px",
                  background: "linear-gradient(to right, transparent, rgba(110,231,183,0.4), transparent)",
                  pointerEvents: "none",
                }}
              />
